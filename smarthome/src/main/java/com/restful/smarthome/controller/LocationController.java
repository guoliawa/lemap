...
import com.restful.smarthome.util.FileUtil;
...
//    @RequestMapping(value = "/locations/user", method = RequestMethod.GET)
    ...
    public String viewUsermap(@RequestParam("id") String userid, Model model) {
        ...
        model.addAttribute("positions",
                infoservice.findPositionByUserid(userid));
    ...
    @RequestMapping(value = "/locations/user")
    public String pagelocation(@RequestParam("id") String userid, Model model) {
        model.addAttribute("userid", userid);
        return "userdata";
    }
    ...
    public ResponseEntity<String> uploadtxt(@RequestParam("id") String userid,
        ...
        String methodName = "uploadtxt";
        logger.info(LocationController.class + "." + methodName + " accepts "
        ...
        if (!file.isEmpty()) {
            try {
                ...
                return new ResponseEntity<String>(userid
                        + " successfully uploaded locations!",
                ...
                return new ResponseEntity<String>(userid
                        ...
                        + e.getMessage(), new HttpHeaders(), HttpStatus.OK);
            }
        } else {
            ...
            return new ResponseEntity<String>(userid
                    + " uploaed an empty file.", new HttpHeaders(),
                    HttpStatus.OK);
        }
    }
    ...
    public ResponseEntity<String> upload(@RequestParam("id") String userid,
        ...
        if (!file.isEmpty()) {
            try {
                ...
                ObjectMapper mapper = new ObjectMapper();
                User newUser = new User(userid);
                File tmpFile = FileUtil.getFile(file, userid);
